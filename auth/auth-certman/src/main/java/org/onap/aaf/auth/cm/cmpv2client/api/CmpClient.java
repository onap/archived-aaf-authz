...
public interface CmpClient {
     ...
     * @return The newly created X509Certificate.
     *
     * @throws CAOfflineException if External CA that is offline
     * @throws CmpClientException if client error occurs.
     */
    X509Certificate createCertRequest(String caName, String profile, CSRMeta csrMeta, Certificate csr,
     ...
     * @return return X509Certificate.
     *
     * @throws CmpClientException if client error occurs.
     */
    X509Certificate revokeCertRequest(String caName, X509Certificate cert, int reason, Date invalidityTime)
        throws CAOfflineException, CmpClientException;
}
