...
public class JU_Log {
	...
	public void testExecError() throws APIException, LocatorException, CadiException, URISyntaxException {
		...
		log.exec(0, new String[]{"add", "test_name"});
		log.exec(0, new String[]{"del", "test_name"});

		log.exec(0, new String[]{"add", "test@somedomain.com"});
		log.exec(0, new String[]{"del", "test@somedomain.com"});
	}
