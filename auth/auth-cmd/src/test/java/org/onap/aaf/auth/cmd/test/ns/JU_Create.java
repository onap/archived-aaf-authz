...
public class JU_Create {
	...
	private Create create;//might need to replace import with org.onap.aaf.auth.cmd.perm
	...
	public void setUp() throws NoSuchFieldException, SecurityException, Exception, IllegalAccessException {
		...
		when(clientMock.create(any(String.class), any(RosettaDF.class), any(NsRequest.class))).thenReturn(futureMock);
