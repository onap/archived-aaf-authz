...
public class MiscID  {
    ...
    */
    ...
    public static void load(Trans trans, Session session ) {
        load(trans, session,selectQuery + FIELD_STRING + " FROM authz.miscid;",data);
    }

    public static void load(Trans trans, Session session, Map<String,MiscID> map ) {
        load(trans, session,selectQuery + FIELD_STRING + " FROM authz.miscid;",map);
    }

    public static void loadOne(Trans trans, Session session, String id ) {
        load(trans, session,selectQuery + FIELD_STRING + " FROM authz.miscid WHERE id ='" + id + "';", data);
    }
